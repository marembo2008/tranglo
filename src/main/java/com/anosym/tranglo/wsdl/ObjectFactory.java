...
public class ObjectFactory {
  ...
  private final static QName _String_QNAME = new QName(EPinReload.EPINRELOAD_TARGET_NAMESPACE, "string");
  private final static QName _Int_QNAME = new QName(EPinReload.EPINRELOAD_TARGET_NAMESPACE, "int");
  ...
  /**
   * Create an instance of {@link RequestReloadAmountNewResponse }
   *
   */
  public RequestReloadAmountNewResponse createRequestReloadAmountNewResponse() {
    return new RequestReloadAmountNewResponse();
  }
  ...
  /**
   * Create an instance of {@link RequestReloadNewResponse }
   *
   */
  public RequestReloadNewResponse createRequestReloadNewResponse() {
    return new RequestReloadNewResponse();
  }

  /**
   * Create an instance of {@link RequestReloadAmountNewResponse.RequestReloadAmountNewResult }
   *
   */
  public RequestReloadAmountNewResponse.RequestReloadAmountNewResult createRequestReloadAmountNewResponseRequestReloadAmountNewResult() {
    return new RequestReloadAmountNewResponse.RequestReloadAmountNewResult();
  }
  ...
  /**
   * Create an instance of {@link RequestReloadAmountNew }
   *
   */
  public RequestReloadAmountNew createRequestReloadAmountNew() {
    return new RequestReloadAmountNew();
  }

  /**
   * Create an instance of {@link RequestReloadNew }
   *
   */
  public RequestReloadNew createRequestReloadNew() {
    return new RequestReloadNew();
  }
   ...
   *
   */
  @XmlElementDecl(namespace = EPinReload.EPINRELOAD_TARGET_NAMESPACE, name = "string")
   ...
   *
   */
  @XmlElementDecl(namespace = EPinReload.EPINRELOAD_TARGET_NAMESPACE, name = "int")
